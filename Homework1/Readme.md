...
Acknowledgments: This assignment was completed in collaboration with other students during study groups. Special thanks to Karla Badillo (floor intersection, resolve contacts & collisions), Sarah Matthews (resolve contacts & collisions), Alex Almodovar (springs), and Ashley Reardon (springs) for their help.
