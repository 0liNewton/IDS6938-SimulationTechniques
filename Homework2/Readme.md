...
- This frequency data was used to construct histograms with bins in incremements of 10 (figures 1 and 2)
...
| Figure 2. Quasi-Number Generator  |
| ------------- |
| ![](images/quasisobol.png?raw=true)  |

| Figure 3. Quasi-Number Generator  |
| ------------- |
...
- Ran a one-sample Kolmogorov-Smirnoff to test the distribution of the engine outputs
- Looking at the last row of the normal distribution table, the p-value is significant
...
-- So we **can not** say that the data **does not** have an approximate uniform distribution
